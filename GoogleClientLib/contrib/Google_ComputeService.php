...
class Google_MachineType extends Google_Model
{
    ...
    public function setAvailableZone( /* array(Google_string) */
        $availableZone)
    {
    ...
    public function setEphemeralDisks( /* array(Google_MachineTypeEphemeralDisks) */
        $ephemeralDisks)
    {
...
class Google_Project extends Google_Model
{
    ...
    public function setExternalIpAddresses( /* array(Google_string) */
        $externalIpAddresses)
    {
...
class Google_Zone extends Google_Model
{
    ...
    public function setAvailableMachineType( /* array(Google_string) */
