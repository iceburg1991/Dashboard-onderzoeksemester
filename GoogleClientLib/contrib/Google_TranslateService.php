...
class Google_DetectionsListResponse extends Google_Model
{
    ...
    public function setDetections( /* array(Google_DetectionsResourceItems) */
        $detections)
    {
...
class Google_LanguagesListResponse extends Google_Model
{
    ...
    public function setLanguages( /* array(Google_LanguagesResource) */
        $languages)
    {
...
class Google_TranslationsListResponse extends Google_Model
{
    ...
    public function setTranslations( /* array(Google_TranslationsResource) */
        $translations)
    {
